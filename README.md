...
| client.quota.callback.static.excluded.principal.name.list                 | String  | ""                      | Semicolon-separated list of principals excluded from the quota. Each principal have to be prefixed with `User:` prefix to exclude it from the quota.                                                        |
