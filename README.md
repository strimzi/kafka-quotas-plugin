[![Build Status](https://github.com/strimzi/kafka-quotas-plugin/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/strimzi/kafka-quotas-plugin/actions/workflows/build.yml?query=branch%3Amain)
